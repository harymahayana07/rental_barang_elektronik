...
private int scorenya,scoretinggi,highscore = 0;
    ...
    private void loadImages() {
        ...
        ImageIcon iia = new ImageIcon("src/image/minum.png");
        minuman = iia.getImage();

        ImageIcon iih = new ImageIcon("src/image/kanan.png");
        kepala = iih.getImage();
    }
    ...
    private void CekMinuman() {
        ...
        if ((x[0] == minuman_x) && (y[0] == minuman_y)) {
            ...
            try        
    {            
    in = new FileInputStream(new File("src\\image\\slurp.wav"));            
    ...
    private void CekTabrakan() {
        ...
        for (int z = dots; z > 0; z--) {
            ...
            if ((z > 5) && (x[0] == x[z]) && (y[0] == y[z])) {
                ...
                try        
    {            
    in = new FileInputStream(new File("src\\image\\beep.wav"));            
    AudioStream audios = new AudioStream(in);            
    AudioPlayer.player.start(audios);        
    }        
    catch(Exception e)                
    ...
    private class TAdapter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if ((key == KeyEvent.VK_LEFT) && (!ArahKanan)) {
                ...
                ArahAtas = false;
                ArahBawah = false;
                 ImageIcon kiri = new ImageIcon("src/image/kiri.png");
        kepala = kiri.getImage();
            ...
            if ((key == KeyEvent.VK_RIGHT) && (!ArahKiri)) {
                ...
                ArahAtas = false;
                ArahBawah = false;
                 ImageIcon kanan = new ImageIcon("src/image/kanan.png");
        kepala = kanan.getImage();
            ...
            if ((key == KeyEvent.VK_UP) && (!ArahBawah)) {
                ...
                ArahKanan = false;
                ArahKiri = false;
               ImageIcon atas = new ImageIcon("src/image/atas.png");
        kepala = atas.getImage();
            ...
            if ((key == KeyEvent.VK_DOWN) && (!ArahAtas)) {
                ...
                ArahKanan = false;
                ArahKiri = false;
                 ImageIcon bawah = new ImageIcon("src/image/bawah.png");
